...
## 进行中
- `/profile` 偏好页尚未交付（I-11）；v5 选择性折叠 I-16（`output_locale`）为 Backlog
...
## 下一张唯一任务
I-16 — `output_locale` 字段与假设维度（sessions/recipes 增 nullable 列 + assumption 维度，additive；不抢做 I-11）
